...
public class ChargeSkill : SkillTest {

	public override IEnumerator skillResolve (GameObject actualPos, Vector3 Direction, float magnitude)
	{
		actualPos.collider.isTrigger = true;
		ColiderManager skillToUse = actualPos.GetComponent<ColiderManager>();
